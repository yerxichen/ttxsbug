 ...
 */
public class HomapagePreferedAdapterOne extends RecyclerView.Adapter<HomapagePreferedAdapterOne.PreferedViewHolder> {

    private Context context;
    private List<JsonBeanHomePage.ProductsCompetitiveBean.DataBean> mList;

    public HomapagePreferedAdapterOne(Context context, List<JsonBeanHomePage.ProductsCompetitiveBean.DataBean> mList) {
    ...
    public void onBindViewHolder(PreferedViewHolder holder, int position) {
        JsonBeanHomePage.ProductsCompetitiveBean.DataBean data = mList.get(position);
