 ...
 */
public class HomapagePreferedAdapter extends RecyclerView.Adapter<HomapagePreferedAdapter.PreferedViewHolder> {

    private Context context;
    private List<JsonBeanHomePage.ProductsCompetitiveBean.Data2Bean> mList;

    public HomapagePreferedAdapter(Context context, List<JsonBeanHomePage.ProductsCompetitiveBean.Data2Bean> mList) {
