	...
	public MyGridLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		if (attrs != null) {
			TypedArray a = getContext().obtainStyledAttributes(attrs,
					styleable.MyGridLayout);
			colums = a.getInteger(styleable.MyGridLayout_numColumns, 4);
			margin = (int) a.getInteger(styleable.MyGridLayout_itemMargin, 2);
		}
	}
