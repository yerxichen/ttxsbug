...
/**
 * Created by taozipc on 2017/12/12.
 */
...
public class MyOptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private MyOnOptionsSelectListener optionsSelectListener;
    ...
    //构造方法
    public MyOptionsPickerView(Builder builder) {
    ...
    public static class Builder {
        ...
        //Required
        public Builder(Context context, MyOnOptionsSelectListener listener) {
        ...
        public MyOptionsPickerView build() {
            return new MyOptionsPickerView(this);
        }
    }
    ...
    public interface MyOnOptionsSelectListener {
