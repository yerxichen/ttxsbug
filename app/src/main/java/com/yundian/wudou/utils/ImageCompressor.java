...
public class ImageCompressor {
    ...
    private static ImageCompressor imageCompressor = null;
    ...
    public static ImageCompressor getInstance(Context context) {
        if (imageCompressor == null) {
            synchronized (ImageCompressor.class) {
                if (imageCompressor == null)
                    imageCompressor = new ImageCompressor(context.getApplicationContext());
            }
        }
        return imageCompressor;
    }

    public ImageCompressor withListener(CompressListener compressListener) {
    ...
    private String getOutputFileName(String srcFilePath) {
        ...
        File file = new File(Environment.getExternalStorageDirectory().getPath(), "Wudoll/Images");
        if (!file.exists()) {
            file.mkdirs();
        }
